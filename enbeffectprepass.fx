/*----------------------------------------------/
 * GP65CJ04's Depth of Field Shader File
 * File Author: gp65cj04
 * File Version: 2
 * Copyright (c) 2012 gp65cj04
 *----------------------------------------------/
 * ENBSeries Depth of Field file
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//#define	NOT_BLURRING_SKY_MODE				// This effect will keep the sky not blurred
#define	DEPTH_OF_FIELD_QULITY 1					// Strengh of blur, increase it mean more blur
#define	AUTO_FOCUS						// Enable Auto Focus
#define TILT_SHIFT						// Enable Tilt or Miniature view from distance
//#define POLYGONAL_BOKEH						// Enable Polygonal Bokeh, Very nice when night
#define	POLYGON_NUM 5						// How much count of the Bokeh Polygon, 3-XX (3= Triangle, 4= Square, 5= Pentagonal, 6= Hexagonal)
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
float2	FocusPoint=float2(0.5, 0.55);
float	FocusSampleRange=1.00;
float	NearBlurCurve=80.00;
float	FarBlurCurve=1.50;
float	DepthClip=1000.0;
...
float	BokehBrightnessMultipiler=2.10;
float	RadiusSacleMultipiler=4.00;

				////////////////////////////////////////////
				///////////NOISE GRAIN & ChA////////////////
				////////////////////////////////////////////
float	NoiseAmount=0.00;
float	NoiseCurve=0.00;
float	ChromaticAberrationAmount=0.30;
